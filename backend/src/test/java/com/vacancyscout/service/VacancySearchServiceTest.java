...
public class VacancySearchServiceTest {
    ...
    private final com.vacancyscout.service.VacancySearchService service = new VacancySearchService(vacancyRepository);
    ...
    void search_withQuery_shouldReturnResults() {
        ...
        SearchFilters filters = new SearchFilters("Java", "ru", null, null, null, null, null, null, null, false, 0, 20);
    ...
    void search_withoutQuery_shouldReturnEmpty() {
        Mockito.when(vacancyRepository.findAllByIsActiveTrueOrderByPostedAtDesc()).thenReturn(Flux.empty());
        SearchFilters filters = new SearchFilters(null, "ru", null, null, null, null, null, null, null, false, 0, 20);
        Mono<SearchResponse<Vacancy>> result = service.search(filters);
